...
@when('Input text {alias}')
def input_text(context, alias):
    AMAZON_SEARCH_FIELD = context.app.header.AMAZON_SEARCH_FIELD
    context.app.header.input_text(alias, *AMAZON_SEARCH_FIELD)
